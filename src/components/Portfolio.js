...
import portfolioImage06 from './images/portfolio-06.jpg';
            ...
            <div style={style} className='portfolio_section' id='portfolio'>
                ...
                <div className='portfolio_section_subtitle'>Take a look at some of my personal and freelance programming projects. </div>
                        ...
                        <div class='portfolio_card'>
                            ...
                            <p className="portfolio_content">HTML | CSS Flex | Javascript | Auth | React.js | Express | Rails | PostGreSQL | GitHub | Heroku | Photoshop</p>
                        ...
                        <div class='portfolio_card'>
                            ...
                            <p className="portfolio_content">HTML | CSS Flex | Javascript | GitHub | Original Photography | Photoshop/Lightroom |</p>    
                        ...
                        <div class='portfolio_card'>
                            ...
                            <p className="portfolio_content">HTML | CSS | Javascript | WordPress | Original Photography | Photoshop/Lightroom</p>
                        ...
                        <div className='portfolio_card'>
                            ...
                            <p className="portfolio_content">HTML | CSS Flex | Javascript | Node | React | Fetch | Marvel API | GitHub | Heroku | Photoshop</p>                    
                        ...
                        <div className='portfolio_card'>
                            <h2 className="portfolio_card_title">React.js App &amp; Message Form</h2>        
                            <p className="portfolio_content">A portfolio website built entirely as a React.js app. Each section serve as components in this single page app. Message form delivery is handled through Netlify hosting services.</p>
                            <p className="portfolio_content">CSS Flex | Javascript | Node | React.js | Netlify | Google Fonts | Photoshop/Lightroom</p>                    
                            <a href='https://github.com/solitonyc/solito-portfolio' target="_blank"> <img className='portfolio_box_image' alt='' src={portfolioImage06} /></a>        
