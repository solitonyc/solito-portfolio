        ...
        return (
            <div className='education_section' id='education'>
                ...
                <div className="education_item_a">
                    ...
                    <p className="degree_descrip">HTML, CSS, JavaScript, Node.js, React.js, PostGreSQL, Ruby, Ruby on Rails, GitHub</p>
                ...
                <div className='education_section_title'>Certifications</div>
                <div className="education_item_a">
