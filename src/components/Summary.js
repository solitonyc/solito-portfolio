        ...
        return (
            <div style={style} className='summary_section' id='summary'>
                <div className="summary_content_container">
                    ...
                    <div className="summary_content">Former CTO, with over 18 years of tech industry experience, seeking a role leveraging leadership qualities, managerial aptitude, busines acumen, software skills and experiences working with tech-minded companies in New York. Possesses extensive experiences overseeing the development and production of software products through its extensive lifecycle from board-room idea to production.</div>
                    <div className="summary_section_subtitle">Possible Roles:</div>
                    <div className="summary_content">Seeking role as Chief Technology Officer, Product Manager or Project Manager. Also has hands on full-stack coding experience.</div>
                </div>
            </div>
        )
    }
